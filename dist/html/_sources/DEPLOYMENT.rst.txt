...
Ce guide vous explique comment déployer le livre IVIA-AF sur Vercel avec
...
3. Le build se fera automatiquement avec la commande :
   ``pip install -r requirements.txt && d2lbook build html``

Analytics
---------

Le projet utilise **Vercel Analytics** intégré, qui est : - ✅
**Automatique** - Pas de configuration supplémentaire - ✅ **Gratuit** -
Inclus avec Vercel - ✅ **Privé** - Respecte la vie privée des
utilisateurs - ✅ **Simple** - Données disponibles dans le dashboard
Vercel
...
Éditez ``static/analytics.js`` pour ajouter de nouveaux événements à
tracker.

Intégrer un autre service d’analytics
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Remplacez le code dans ``static/analytics.js`` par l’intégration de
votre choix.
...
Pour toute question ou problème : - Email : contact@ivia.africa - GitHub
: https://github.com/IVIA-AF/livre
