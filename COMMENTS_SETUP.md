...
Ce guide explique comment configurer et utiliser le système de commentaires intégré dans votre projet livre IVIA-AF.

## 🎯 Vue d'ensemble

Le système de commentaires permet aux lecteurs de :
...
1. **Accéder** au [panneau d'administration Disqus](https://disqus.com/admin/)
...
- **Template personnalisé** : `static/custom_template.html`
...
Le système fonctionne sur toute plateforme statique :
- GitHub Pages
- Netlify
- Surge
- etc.
